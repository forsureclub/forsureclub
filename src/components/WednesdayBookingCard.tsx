...
import { WednesdayTierCard } from "./WednesdayTierCard";
...
export const WednesdayBookingCard = ({ club, onBookingComplete }: WednesdayBookingCardProps) => {
  ...
  return (
    <div className="space-y-6">
      {/* Tier Status Card */}
      {showTierCard && (
        <WednesdayTierCard playerEmail="player@example.com" />
      )}
      ...
      <Card className="border-2 border-orange-200 bg-gradient-to-br from-orange-50 to-orange-100">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex flex-col gap-2">
            <Button
              onClick={() => setShowTierCard(!showTierCard)}
              className="w-full bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700"
            >
              <Star className="h-4 w-4 mr-2" />
              {showTierCard ? 'Hide' : 'View'} Wednesday Warrior Status
            </Button>
